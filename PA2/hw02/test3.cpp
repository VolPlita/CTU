...
public:
	...
	bool add ( const string & name, const string & surname, const string & email, unsigned int salary ) // 4n + log(n)
	{
        ...
        //m_byName.insert(upper_bound(m_byName.begin(), m_byName.end(), new_employee, ), new_employee);

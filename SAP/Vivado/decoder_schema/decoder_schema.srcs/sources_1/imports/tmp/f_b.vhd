...
architecture Behavioral of f_b_vhdl is
...
begin
	...
	-- and_1
	and_1_O <= not(C0_1) and not(D0_1);

	-- and_2
	and_2_O <= not(A0_1) and not(B0_1) and not(D0_1);

	-- and_3
	and_3_O <= A0_1 and B0_1 and not(D0_1);

	-- and_4
	and_4_O <= A0_1 and not(B0_1) and D0_1;
